...
begin
  if (mValidar(mnPosicion,nPosicion)==false) then  //validación inicial
    return false;
...
begin
  ...
  if (!mValidar(mnPosicion,nPosicion)) then  //validación inicial
	return false;
